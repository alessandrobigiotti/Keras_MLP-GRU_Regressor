...
raw_1min_data = os.path.join(str(base_dir), "Data", "Normalized_1Min_Price")
raw_1min_data_smoothed = os.path.join(str(base_dir), "Data", "Normalized_1Min_SmoothedPrice")
input_data = os.path.join(str(base_dir), "Data", "Input_Data")
